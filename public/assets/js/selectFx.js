...
(function(window) {
    ...
    function setZIndexes() {
        var allSelects = document.querySelectorAll('div.cs__select');
        for (var j = 0; j < allSelects.length; j++) {
            allSelects[j].style.zIndex = '99';
        }

        var openSelect = document.querySelectorAll('.cs__select.cs-active');
        if (openSelect.length > 0) {
            openSelect[0].style.zIndex = '100';
        }
    }
    /**
     * SelectFx function
    ...
    SelectFx.prototype._createSelectEl = function() {
        ...
        var opts_el =
            '<div class="cs__select--options"><ul>' + options + '</ul></div>';
        var frag = document.createDocumentFragment();
        this.selEl = frag.appendChild(document.createElement('div'));
        this.selEl.className = this.el.className;
        this.selEl.tabIndex = this.el.tabIndex;
        this.selEl.innerHTML =
            '<span class="cs__select--placeholder" data-placeholder="' +
